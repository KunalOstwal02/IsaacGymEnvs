...
class FrankaCabinetAddBox(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        # [Kunal] Added this line to load box asset
        ...
        max_agg_bodies = num_franka_bodies + num_cabinet_bodies + num_box_bodies
        max_agg_shapes = num_franka_shapes + num_cabinet_shapes + num_box_shapes
        ...
        for i in range(self.num_envs):
            ...
            # [Kunal] - Append box actor to boxes list
