...
class FrankaCabinetRemoveCabinet(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        max_agg_bodies = num_franka_bodies + num_box_bodies + num_cylinder_bodies
        max_agg_shapes = num_franka_shapes + num_box_shapes + num_cylinder_shapes
        ...
        for i in range(self.num_envs):
            ...
            box_actor = self.gym.create_actor(env_ptr, box_asset, box_pose, "box", i, 2, 0)
            ...
            cylinder_actor = self.gym.create_actor(env_ptr, cylinder_asset, cylinder_pose, "cylinder", i, 3, 0)
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.reset_buf[:] = compute_franka_reward(
            self.reset_buf, self.progress_buf, self.actions, self.box_dof_pos,
    ...
    def reset_idx(self, env_ids):
        ...
        # reset cabinet
        self.cylinder_dof_state[env_ids, :] = torch.zeros_like(self.cylinder_dof_state[env_ids])
    ...
    def post_physics_step(self):
        ...
        if self.viewer and self.debug_viz:
            ...
            for i in range(self.num_envs):
                ...
                p0 = self.cylinder_grasp_pos[i].cpu().numpy()
...
def compute_franka_reward(
        reset_buf, progress_buf, actions, box_dof_pos,
    ...
    # distance from hand to the cylinder
    ...
    around_handle_reward = torch.where(franka_lfinger_pos[:, 2] > cylinder_grasp_pos[:, 2],
